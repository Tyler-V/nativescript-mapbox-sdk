...
export class Location extends MapboxLocation {
  ...
  startTracking(options: LocationOptions): Promise<void> {
    ...
    return new Promise((resolve, reject) => {
      let camera = this.mapboxView.nativeMapView.camera;
      ...
      try {
        ...
        this.mapboxView.nativeMapView.setUserTrackingModeAnimated(_getTrackingMode(options.cameraMode), true);
        this.mapboxView.nativeMapView.userTrackingMode =  _stringToCameraMode( options.cameraMode );
